...
const ::google::protobuf::Descriptor* TranRequest_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  TranRequest_reflection_ = NULL;
const ::google::protobuf::Descriptor* TranResponse_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  TranResponse_reflection_ = NULL;
const ::google::protobuf::ServiceDescriptor* EchoService_descriptor_ = NULL;
const ::google::protobuf::ServiceDescriptor* TranService_descriptor_ = NULL;
...
void protobuf_AssignDesc_helloworld_2eproto() {
  ...
  FooResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(FooResponse));
  TranRequest_descriptor_ = file->message_type(2);
  static const int TranRequest_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TranRequest, text_),
  };
  TranRequest_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      TranRequest_descriptor_,
      TranRequest::default_instance_,
      TranRequest_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TranRequest, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TranRequest, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(TranRequest));
  TranResponse_descriptor_ = file->message_type(3);
  static const int TranResponse_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TranResponse, text_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TranResponse, result_),
  };
  TranResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      TranResponse_descriptor_,
      TranResponse::default_instance_,
      TranResponse_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TranResponse, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TranResponse, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(TranResponse));
  EchoService_descriptor_ = file->service(0);
  TranService_descriptor_ = file->service(1);
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    TranRequest_descriptor_, &TranRequest::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    TranResponse_descriptor_, &TranResponse::default_instance());
}
...
void protobuf_ShutdownFile_helloworld_2eproto() {
  ...
  delete TranRequest::default_instance_;
  delete TranRequest_reflection_;
  delete TranResponse::default_instance_;
  delete TranResponse_reflection_;
}
...
void protobuf_AddDesc_helloworld_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "t\022\014\n\004text\030\001 \002(\t\",\n\014TranResponse\022\014\n\004text\030"
    "\001 \002(\t\022\016\n\006result\030\002 \001(\0102/\n\013EchoService\022 \n\003"
    "Foo\022\013.FooRequest\032\014.FooResponse22\n\013TranSe"
    "rvice\022#\n\004Tran\022\014.TranRequest\032\r.TranRespon"
    "seB\003\200\001\001", 287);
  ...
  TranRequest::default_instance_ = new TranRequest();
  TranResponse::default_instance_ = new TranResponse();
  FooRequest::default_instance_->InitAsDefaultInstance();
  FooResponse::default_instance_->InitAsDefaultInstance();
  TranRequest::default_instance_->InitAsDefaultInstance();
  TranResponse::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int TranRequest::kTextFieldNumber;
#endif  // !_MSC_VER

TranRequest::TranRequest()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void TranRequest::InitAsDefaultInstance() {
}

TranRequest::TranRequest(const TranRequest& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void TranRequest::SharedCtor() {
  _cached_size_ = 0;
  text_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void TranRequest::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* TranRequest::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return TranRequest_descriptor_;
}

const TranRequest& TranRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_helloworld_2eproto();
  return *default_instance_;
}

TranRequest* TranRequest::default_instance_ = NULL;

TranRequest* TranRequest::New() const {
  return new TranRequest;
}

void TranRequest::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (has_text()) {
      if (text_ != &::google::protobuf::internal::kEmptyString) {
        text_->clear();
...
bool TranRequest::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void TranRequest::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
::google::protobuf::uint8* TranRequest::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
int TranRequest::ByteSize() const {
  int total_size = 0;
...
void TranRequest::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const TranRequest* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const TranRequest*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void TranRequest::MergeFrom(const TranRequest& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_text()) {
      set_text(from.text());
...
void TranRequest::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void TranRequest::CopyFrom(const TranRequest& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool TranRequest::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;

  return true;
}

void TranRequest::Swap(TranRequest* other) {
  if (other != this) {
    std::swap(text_, other->text_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
...
::google::protobuf::Metadata TranRequest::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = TranRequest_descriptor_;
  metadata.reflection = TranRequest_reflection_;
  return metadata;
}
...
#ifndef _MSC_VER
const int TranResponse::kTextFieldNumber;
const int TranResponse::kResultFieldNumber;
#endif  // !_MSC_VER
...
void TranResponse::InitAsDefaultInstance() {
}

TranResponse::TranResponse(const TranResponse& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void TranResponse::SharedCtor() {
  _cached_size_ = 0;
  text_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  result_ = false;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
void TranResponse::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* TranResponse::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return TranResponse_descriptor_;
}

const TranResponse& TranResponse::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_helloworld_2eproto();
  return *default_instance_;
}

TranResponse* TranResponse::default_instance_ = NULL;

TranResponse* TranResponse::New() const {
  return new TranResponse;
}

void TranResponse::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (has_text()) {
      if (text_ != &::google::protobuf::internal::kEmptyString) {
        text_->clear();
...
bool TranResponse::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void TranResponse::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
::google::protobuf::uint8* TranResponse::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
int TranResponse::ByteSize() const {
  int total_size = 0;
...
void TranResponse::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const TranResponse* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const TranResponse*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void TranResponse::MergeFrom(const TranResponse& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_text()) {
      set_text(from.text());
...
void TranResponse::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void TranResponse::CopyFrom(const TranResponse& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool TranResponse::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;

  return true;
}

void TranResponse::Swap(TranResponse* other) {
  if (other != this) {
    std::swap(text_, other->text_);
    std::swap(result_, other->result_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
...
::google::protobuf::Metadata TranResponse::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = TranResponse_descriptor_;
  metadata.reflection = TranResponse_reflection_;
  return metadata;
}
...
const ::google::protobuf::ServiceDescriptor* TranService::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return TranService_descriptor_;
}

const ::google::protobuf::ServiceDescriptor* TranService::GetDescriptor() {
  protobuf_AssignDescriptorsOnce();
  return TranService_descriptor_;
}

void TranService::Tran(::google::protobuf::RpcController* controller,
                         const ::TranRequest*,
                         ::TranResponse*,
                         ::google::protobuf::Closure* done) {
...
void TranService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ::google::protobuf::RpcController* controller,
                             const ::google::protobuf::Message* request,
                             ::google::protobuf::Message* response,
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), TranService_descriptor_);
  switch(method->index()) {
    case 0:
      Tran(controller,
             ::google::protobuf::down_cast<const ::TranRequest*>(request),
             ::google::protobuf::down_cast< ::TranResponse*>(response),
             done);
      break;
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
...
const ::google::protobuf::Message& TranService::GetRequestPrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
      return ::TranRequest::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
...
const ::google::protobuf::Message& TranService::GetResponsePrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
      return ::TranResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *reinterpret_cast< ::google::protobuf::Message*>(NULL);
  }
...
TranService_Stub::TranService_Stub(::google::protobuf::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
...
void TranService_Stub::Tran(::google::protobuf::RpcController* controller,
